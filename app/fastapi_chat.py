"""FastAPI chat routes for persistent conversations and assistant requests.

This module mirrors the current Flask chat flow so the existing templates,
session handling, document uploads, and tool-calling assistant continue to work
while the app migrates to FastAPI.
"""
