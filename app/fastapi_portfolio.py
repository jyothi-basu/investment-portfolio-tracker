"""FastAPI routes for portfolio management and holdings views.

This router mirrors the existing Flask portfolio pages while keeping the
business rules in `app.services.portfolio_service`. It is a migration layer
only; the Flask routes remain available until the framework swap is complete.
"""
...
from app.fastapi_auth import get_authenticated_user_id
